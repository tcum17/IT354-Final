const PLANTS = [
    {
        ...
        toxicity: "Medium",
        water: "1-2 weeks or when the majority of the top soil is dry. You should water until it flows through drainage holes",
        interval: 10,
    ...
    },
    {
        ...
        humidity:
            "Prefers relatively humid environment, but can handle most levels of humidity",
        toxicity: "Medium",
        water: "1-2 weeks or when half of the soil is dry. You should water until it flows through drainage holes",
        interval: 8,
    ...
    },
    {
        ...
        humidity:
            "Prefer average to humid environments. Misting is recommended",
        toxicity: "Medium",
        water: "2-4 Weeks or when majority or all of the soil is dry. Use filtered water if possible",
        interval: 16,
        image: "images/cornplant.png",
    },
    {
        id: 4,
        name: "Button Fern",
        ...
        toxicity: "Non-Toxic",
        water: "Weekly or when top 1-2 inches are dry. Be careful not to overwater it. Make sure you water it enough, but don't make the soil soggy",
        interval: 5,
        image: "images/buttonfern.jpg",
    },
    {
        id: 5,
        name: "Spider Plant",
        ...
        humidity:
            "Low to more humid. However, misting is generally recommended.",
        toxicity: "Non-Toxic",
        water: "Weekly or when top half of soil is dry. You should water it until the water flows through drainage holes. Use filtered water if possible",
        interval: 7,
    ...
    },
    {
        ...
        humidity:
            "Normal to more humid. Prefers more humid conditions if possible",
        toxicity: "Irratative",
    ...
    },
    {
        ...
        interval: 10,
        image: "images/pottedjadeplant.jpg",
    },
];
